...
/*   Updated: 2026/03/27 13:41:11 by ele-moig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	text_calc(t_game *game, t_ray *ray)
{
	...
	if (ray->side == 1 && ray->dir->y < 0)
		ray->tex_x = TEXT_WIDTH - ray->tex_x - 1;
	ray->step = 1.0 * TEXT_HEIGHT / ray->line_height;
	ray->text_pos = (ray->draw_start - WIN_HEIGHT / 2.0 + ray->line_height / 2.0) * ray->step;
}
